...
[System.Serializable]
public partial class TurretController : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        if (this.yawSegment && (this.yawLimit != 0f))
        {
            ...
            if ((this.yawLimit < 360f) && (this.yawLimit > 0f)) this.yawSegment.rotation = Quaternion.RotateTowards(this.yawSegment.rotation * this.yawSegmentStartRotation, targetRotation, this.yawLimit);
        ...
        if (this.pitchSegment && (this.pitchLimit != 0f))
        {
            ...
            if ((this.pitchLimit < 360f) && (this.pitchLimit > 0f)) this.pitchSegment.rotation = Quaternion.RotateTowards(this.pitchSegment.rotation * this.pitchSegmentStartRotation, targetRotation, this.pitchLimit);
